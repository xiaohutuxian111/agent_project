...
import json5
import time
from agent_project.第三章_Agent原理与最佳实践.code.simple_agent.tools import Tools
from agent_project.第三章_Agent原理与最佳实践.code.simple_agent.llm import Siliconflow

from  agent_project import model_name, model_url, model_api_key, google_api_url, google_api_key


class ReactAgent:
    def __init__(self, model_name: str = '', model_url: str = '', model_api_key: str = '',google_api_url: str = '',google_api_key: str = '') -> None:
        """初始化 React Agent"""
        self.tools = Tools(google_api_key=google_api_key,google_api_url=google_api_url)                    
        self.model = Siliconflow(model_api_key=model_api_key,model_url=model_url,model_name=model_name)     
...
if __name__ == "__main__":
    agent = ReactAgent(model_name=model_name,model_url=model_url,model_api_key=model_api_key,google_api_url=google_api_url,google_api_key=google_api_key)
