...
class Tools:
    ...
    def __init__(self,google_api_key:str,google_api_url:str='')  -> None:
        self.google_api_key = google_api_key
        self.google_api_url = google_api_url
        if not self.google_api_url:
            self.google_api_url = "https://google.serper.dev/search"
    ...
    def get_tool_descriptions(self, tool_name: str) -> str:
        """获取工具描述"""
...
if __name__ == "__main__":
    from  angent_project import google_api_key, google_api_url
    tools = Tools(google_api_key, google_api_url)
